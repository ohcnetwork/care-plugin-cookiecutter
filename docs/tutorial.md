...
> **Note:** Did you find any of these instructions confusing? [Edit this file](https://github.com/ohcnetwork/care-plugin-cookiecutter/blob/master/docs/tutorial.md) and submit a pull request with your improvements!
